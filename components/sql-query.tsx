...
export function SQLQuery() {
	...
	return (
		<div className="flex flex-column border-2 rounded-sm">
			<ResizablePanelGroup direction="vertical" className="min-h-[70vh] border">
				<div className="flex flex-row items-center bg-background border m-2 p-2 h-[50px] gap-2 rounded-xl">
				...
				<ResizablePanel defaultSize={80}>
					<div className="bg-background border p-2 m-2 h-full overflow-y-auto rounded-xl">
						{tables && (
							<Editor
								language="sql"
								options={{
				...
				<ResizablePanel defaultSize={20}>
					<div className="bg-background border p-2 m-2 h-full rounded-xl">
						<DataViewTable data={data} />
					</div>
				</ResizablePanel>
				{data.length > 0 && (
					<Pagination className="flex flex-row justify-end w-full p-2">
						<PaginationContent>
							<PaginationItem>
								<PaginationPrevious
